    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <form class="card-body" wire:submit.prevent="update" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-merge">
                                <input type="text" id="email" class="form-control"  aria-describedby="email2" name="email" wire:model.defer="email">
                    ...
                    <div class="row mb-3 form-password-toggle">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-merge">
                                <input type="password" id="password" class="form-control"  aria-describedby="password2" name="password"  wire:model.defer="password">
