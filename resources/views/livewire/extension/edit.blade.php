        ...
        <form class="card-body" wire:submit.prevent="update" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-12">
                    ...
                    <textarea id="extension" class="form-control" name="extension" wire:model="extension"></textarea>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="number" id="quantity" class="form-control" name="quantity" wire:model="quantity">
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea id="beneficiaries" class="form-control" name="beneficiaries" wire:model="beneficiaries"></textarea>
                </div>
            </div>
