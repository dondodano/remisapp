        ...
        <form class="card-body" wire:submit.prevent="update" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="date" id="date_published" class="form-control" name="date_published"  wire:model="date_published">
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea id="publisher" class="form-control" name="publisher" wire:model="publisher"></textarea>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="volume" class="form-control" name="volume" wire:model="volume">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="issue" class="form-control" name="issue" wire:model="issue">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="page" class="form-control" name="page" wire:model="page">
                </div>
            </div>
