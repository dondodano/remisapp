            ...
            <div class="col-lg-6">
                ...
                <div class="mb-5 mb-lg-0 text-center text-lg-start">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge" src="{{ asset('assets/landing/assets/img/google-play-badge.svg') }}" alt="..." /></a>
                        <a href="#!"><img class="app-badge" src="{{ asset('assets/landing/assets/img/app-store-badge.svg') }}" alt="..." /></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
