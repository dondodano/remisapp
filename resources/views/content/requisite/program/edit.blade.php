            ...
            <div class="card-body">
                <form action="/program/edit/{{ $program->id }}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="term" class="form-control " name="term" value="{{ $program->term }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="definition">Definition</label>
                        <div class="col-sm-10">
                            <textarea id="definition" class="form-control" name="definition">{{ $program->definition }}</textarea>
                        </div>
                    </div>
