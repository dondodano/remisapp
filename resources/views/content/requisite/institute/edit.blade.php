...
<div class="row">
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/institute/edit/{{ $institute->id }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="term" class="form-control phone-mask" name="term" value="{{ $institute->term }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="definition">Definition</label>
                        <div class="col-sm-10">
                            <textarea id="definition" class="form-control" name="definition">{{ $institute->definition }}</textarea>
                        </div>
                    </div>
