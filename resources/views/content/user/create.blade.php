...
<div class="row">
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <form class="card-body" method="post" action="/user/create" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group input-group-merge">
                            <input type="text" id="email" class="form-control"  aria-describedby="email2" name="email" value="{{ sessionGet('input.email') }}">
                ...
                <div class="row mb-3 form-password-toggle">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group input-group-merge">
                            <input type="password" id="password" class="form-control"  aria-describedby="password2" name="password" value="{{ sessionGet('input.password') }}">
                    ...
                    <div class="col-sm-9">
                        <select  id="role" class="form-select" name="role" value="{{ sessionGet('input.role') }}">
                            ...
                            @foreach($roles as $role)
                                @if(sessionGet('input.role') == $role->id)
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="firstname" class="form-control" name="firstname" value="{{ sessionGet('input.firstname') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label text-sm-end" for="middlename">Middle Name</label>
                    <div class="col-sm-9">
                        <input type="text" id="middlename" class="form-control" name="middlename"  value="{{ sessionGet('input.middlename') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label text-sm-end" for="lastname">Last Name</label>
                    <div class="col-sm-9">
                        <input type="text" id="lastname" class="form-control" name="lastname"  value="{{ sessionGet('input.lastname') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label text-sm-end" for="extension">Extension</label>
                    <div class="col-sm-9">
                        <input type="text" id="extension" class="form-control" name="extension"  value="{{ sessionGet('input.extension') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label text-sm-end" for="title">Title</label>
                    <div class="col-sm-9">
                        <input type="text" id="title" class="form-control" name="title"  value="{{ sessionGet('input.title') }}">
                    </div>
                </div>
