...
class CreateEvaluationExtensionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation_extension', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluation_extension');
    }
}
