...
class CreateEvaluationTrainingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation_training', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluation_training');
    }
}
