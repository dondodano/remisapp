...
class CreateEvaluationResearchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation_research', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluation_research');
    }
}
