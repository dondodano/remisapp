...
class CreateAttachmentResearchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('attachment_research', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('attachment_research');
    }
}
