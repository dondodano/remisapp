...
class CreateEvaluationPartnershipTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation_partnership', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluation_partnership');
    }
}
