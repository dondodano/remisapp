...
class CreateEvaluationPresentationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation_presentation', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evaluation_presentation');
    }
}
