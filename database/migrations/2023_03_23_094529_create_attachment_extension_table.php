...
class CreateAttachmentExtensionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('attachment_extension', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('attachment_extension');
    }
}
